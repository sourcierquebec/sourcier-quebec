...
**État au 2026-04-16** : Palette « editorial » active. Design responsive fonctionnel. Correctif mobile appliqué le 2026-04-16 : ajout `box-sizing: border-box` global, `min-width: 0` sur les contrôles de formulaire, zones tactiles radio 44px, FAQ et footer adaptés mobile. Le formulaire contact utilise FormSubmit.co (POST vers sourcierquebec@gmail.com). Aucun CMS encore intégré — phase maquette/validation.
